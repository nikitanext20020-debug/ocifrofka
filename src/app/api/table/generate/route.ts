      ...
      messages: [
        {
          ...
          content: [
            ...
            " Каждый текст должен состоять ровно из двух ОЧЕНЬ КОРОТКИХ предложений (суммарно не более 15-20 слов на всё обращение). Это критически важно. Не используй сложные обороты. Пиши максимально лаконично, как житель в мессенджере.",
