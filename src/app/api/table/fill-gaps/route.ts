    ...
    messages: [
      {
        ...
        content: [
          ...
          " Если «Текст наказа» содержит одно-два общих слова, например «спорт», «ЖКХ», «дороги» или «благоустройство», разверни их в ОЧЕНЬ КРАТКИЙ (до 10-12 слов) текст обращения. Не пиши длинные предложения.",
          ...
          " Телефонные номера не придумывай и не дополняй цифрами: если номер в gaps неполный или некорректный — пропусти его, не возвращай изменение для этой ячейки.",
