      ...
      messages: [
        {
          ...
          content: [
            ...
            "Остальные поля: address — адрес проживания; birth_date — дата рождения; phone — номер мобильного телефона; topic — исходный текст/тема наказа.",
            "Если есть отдельные колонки «Тематика предложения», «Направление обращения» и «Текст наказа», для topic всегда выбирай «Текст наказа». «Тематика предложения» и «Направление обращения» — производные классификации, а не исходная тема.",
