...
- Адрес
- Телефон
Переписывай данные точно как в документе, ничего не выдумывай. Если поле отсутствует или написано неразборчиво — поставь прочерк «-» Никаких знаков вопроса. Если ты видишь явную ошибку в слове то лучше сразу исправь. В confidence_notes кратко укажи, что разобрал плохо. Отвечай строго в заданном JSON-формате.`;
