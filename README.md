...
- ИИ-анализ колонок, поддержка ФИО в одной или трёх отдельных колонках, фиксированные значения категориальных полей и безопасное заполнение пропусков только в последних добавленных строках.
