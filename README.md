...
- ИИ-анализ колонок, поддержка ФИО в одной или трёх отдельных колонках, нормализация новых записей и безопасное заполнение пропусков только в последних добавленных строках.
